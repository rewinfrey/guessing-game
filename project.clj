(defproject guessing_game "0.1.0-SNAPSHOT"
  ...
  :cljsbuild ~(let [run-specs ["bin/specljs"  "resources/public/javascript/guessing_game_dev.js"]]
          {:builds {:dev {:source-paths ["src/cljs" "spec/cljs"]
                               :compiler {:output-to "resources/public/javascript/guessing_game_dev.js"
                                          :optimizations :whitespace
                                          :pretty-print true}
                          :notify-command run-specs}
                     :prod {:source-paths ["src/cljs"]
                             :compiler {:output-to "resources/public/javascript/guessing_game.js"
                                        :optimizations :simple}}}
            :test-commands {"test" run-specs}})

  :source-paths ["src/clj" "src/cljs"]
  :test-paths ["spec/clj"]
  :ring {:handler guessing_game.main/app
         :init guessing_game.init/init})
